...
const HomePage = () => {
    ...
    const getRestaurants = async () => {
        try {
            const response = await axios.get(`https://halal-express-kbylfmtyz-ampoldellovas-projects.vercel.app//api/restaurant/list`);
    ...
    const getFoods = async () => {
        try {
            const response = await axios.get(`https://halal-express-kbylfmtyz-ampoldellovas-projects.vercel.app//api/foods/list`);
